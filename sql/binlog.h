...
class HybridLogicalClock {
 public:
   ...
   * clock
   *
   * @return A map of database->applied_hlc
   */
   ...
   *
   * @param [in] database - A database name to select HLC for
   *
   ...
   *
   * @param [in] hlc - The HLC value to validate
   */
...
class MYSQL_BIN_LOG : public TC_LOG {
  ...
  */
  ...
  void set_psi_keys(
      ...
      PSI_mutex_key key_LOCK_non_xid_trxs, PSI_mutex_key key_LOCK_log_info,
 ...
 public:
  /** register binlog/relay (its IO_CACHE) and mutexes to plugin.
      ...
      @param need_lock - If true, take LOCK_log
  ...
  */
  void adjust_linfo_offsets(my_off_t purge_offset, bool is_relay_log);
  void adjust_linfo_in_dump_threads(bool is_relay_log);
