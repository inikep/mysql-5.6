...
class Metadata_event : public Binary_log_event {
 public:
   ...
   *
   * @param checkpoint raft term/index of the ingestion checkpoint
   */
   ...
   *
   * @param upper_bound raft ingestion upper bound
   */
 ...
 protected:
   ...
   *
   * @param type - set to true to indicate it exists in thie event
   */
