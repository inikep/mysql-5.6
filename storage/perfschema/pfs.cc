...
void pfs_snapshot_statement_helper(PSI_statement_locker *locker, void *stmt_da,
  ...
  if (flags == 0 || !state->m_capture_stats_periodic) {
    return;
  }
  ...
  */
  ...
  if (pfs_flags & STATE_FLAG_BASE) {
    ...
    unsigned long long rows_examined = state->current_state.m_rows_examined -
                                       state->prev_state.m_rows_examined;
    ...
    unsigned long long compilation_cpu =
    ...
    unsigned long long rows_inserted = state->current_state.m_rows_inserted -
                                       state->prev_state.m_rows_inserted;
    ...
    unsigned long long no_index_used = state->current_state.m_no_index_used -
                                       state->prev_state.m_no_index_used;
        ...
        if (state->m_in_prepare) {
          ...
          if (prepared_stmt_stat != nullptr) {
            ...
            prepared_stmt_stat->m_sort_merge_passes +=
                state->current_state.m_sort_merge_passes;
            prepared_stmt_stat->m_sort_range +=
                state->current_state.m_sort_range;
  ...
  if (with_telemetry) {
    ...
    tel_data.m_lock_time = state->current_state.m_lock_time;
    ...
    tel_data.m_rows_sent = state->current_state.m_rows_sent;
    tel_data.m_rows_examined = state->current_state.m_rows_examined;
    tel_data.m_created_tmp_disk_tables =
        state->current_state.m_created_tmp_disk_tables;
    tel_data.m_created_tmp_tables = state->current_state.m_created_tmp_tables;
    tel_data.m_select_full_join = state->current_state.m_select_full_join;
    tel_data.m_select_full_range_join =
        state->current_state.m_select_full_range_join;
    tel_data.m_select_range = state->current_state.m_select_range;
    tel_data.m_select_range_check = state->current_state.m_select_range_check;
    tel_data.m_select_scan = state->current_state.m_select_scan;
    tel_data.m_sort_merge_passes = state->current_state.m_sort_merge_passes;
    tel_data.m_sort_range = state->current_state.m_sort_range;
    tel_data.m_sort_rows = state->current_state.m_sort_rows;
    tel_data.m_sort_scan = state->current_state.m_sort_scan;
    tel_data.m_no_index_used = state->current_state.m_no_index_used;
    tel_data.m_no_good_index_used = state->current_state.m_no_good_index_used;
